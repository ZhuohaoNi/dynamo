...
pub async fn run_with_frontend_route_extensions(
    ...
    let http_service = match engine_config {
        EngineConfig::Dynamic {
            ...
            let enabled_generate_backends = http_service.enabled_generate_backends();
            run_watcher(
...
async fn run_watcher(
    ...
    enabled_generate_backends: service_v2::EnabledGenerateBackends,
) -> anyhow::Result<()> {
    ...
    watch_obj.set_enabled_generate_backends(enabled_generate_backends);
